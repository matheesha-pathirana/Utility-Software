...
########################################################################################################################
# des_dir = f"D:/Program Files (x86)/Cryptical/log/Log_{today}_{rand_number}"
# os.mkdir(des_dir)
# prog_dir= "D:/Program Files (x86)/Cryptical/log/"
# try:
#     shutil.move(f"D:/OneDrive - adithya/Programming/Python/Utility Software/log/Log_{today}_{rand_number}.txt", f"D:/Program Files (x86)/Cryptical/log/Log_{today}_{rand_number}/Log_{today}_{rand_number}")
# except FileExistsError:
#     print('file already access!')
